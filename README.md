...
# アプリケーションを作成した背景
今年小学校にあがったばかりの子どもが、初めての自由研究にとまどっていてなかなか取り掛かることができなかったため。
自由研究のアイデアを、子ども自身が興味のあることを出発点として楽しく見つけ、前向きな気持ちで楽しく取りかかれることを目指しました。
人は、自分でやりたいと思ったことには積極的に取り組む一方で、他人から強要されると反発しがちです。自由研究はその自由さゆえに、何をすればよいのか分からずに戸惑ってしまう子どもたちも少なくありません。そのため、このアプリケーションは、子どもたちが自由研究のアイデアを自分の好きなもので楽しく見つけ、前向きな気持ちで楽しく取りかかれることを目標にしています。自発的に取り組むことで学習の効果が高まり、長期的な成長にもつながる期待も込めています。
...
- **インフラ**: AWS (EC2, RDS)
- **その他**: GitHub, openAI API, Visual Studio Code (VSCode)

## 開発環境
- **OS**: Windows 11
- **ターミナル**: PowerShell 7, コマンドプロンプト, AWS CloudShell
- **テキストエディタ**: Vim, Visual Studio Code (VSCode)
- **データベース管理**: DBeaver
...
その結果、今年の自由研究は「ビスケットは何回たたくと1億個になるか」をテーマに無事完成させました。子どもは最後まで楽しく取り組めたようでよかったです。学ぶことは面白いと楽しむきっかけになっていればいいです。

<img src="docs/自由研究.png" alt="自由研究" width="50%">

# 実装予定の機能
- **コメント機能**:他の人から「そのアイデアおもしろそうだね」「○○を入れてみるともっとおもしろくなりそうだね」などとフィードバックを得られると、より具体的に考えるきっかけになりそう。
- **いいね機能**:
- **検索機能**:
