...
- Basic認証パスワード：admin1
- Basic認証ID：1234
- メールアドレス：tttt1@ttt.com
- パスワード：ttttt1

# 利用方法
1. トップページ（一覧ページ）のヘッダーから新規登録を行う  
<img src="docs/ヘッダー_ログイン_新規登録.png" alt="ヘッダー_ログイン_新規登録" width="35%">
...
3. 生成するのに数十秒かかることもあります。  
生成すると画面右の「みんなのじゆうけんきゅうのアイデア」の最上部に「できたてのアイデア」表示とともに表示されます。
<img src="docs/みんなのじゆうけんきゅうのアイデア.png" alt="みんなのじゆうけんきゅうのアイデア" width="70%">
...
- **新着表示機能**: 24時間以内の投稿には「できたてのアイデア」表示が付く機能。
